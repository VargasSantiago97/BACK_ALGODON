...
const campanasModel = require('../models/campanas');

var route = express.Router();

route.get('/', async function (req, res) {
    try {
        const data = await campanasModel.find({});
...
route.get('/:id', async function (req, res) {
    ...
    try {
        const data = await campanasModel.findById(id);
...
route.post('/', async function (req, res) {
    try {
        ...
        const data = await campanasModel.create(req.body);
...
route.put('/:id', async function (req, res) {
    ...
    try {
        const data = await campanasModel.findByIdAndUpdate(id, req.body, { useFindAndModify: false });
...
route.delete('/:id', async function (req, res) {
    ...
    try {
        const data = await campanasModel.deleteOne({ _id: id })
