...
const establecimientosModel = require('../models/establecimientos');

var route = express.Router();

route.get('/', async function (req, res) {
    try {
        const data = await establecimientosModel.find({});
...
route.get('/:id', async function (req, res) {
    ...
    try {
        const data = await establecimientosModel.findById(id);
...
route.post('/', async function (req, res) {
    try {
        ...
        const data = await establecimientosModel.create(req.body);
...
route.put('/:id', async function (req, res) {
    ...
    try {
        const data = await establecimientosModel.findByIdAndUpdate(id, req.body, { useFindAndModify: false });
...
route.delete('/:id', async function (req, res) {
    ...
    try {
        const data = await establecimientosModel.deleteOne({ _id: id })
